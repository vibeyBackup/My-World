function captureSelectedOption() {
  ...
  audioElement.src = "../myWorld/assets/myLove.mp3";
  ...
  if (selectedValue === "144p") {
    imageElement.src = "../myWorld/assets/world144.jpg";
    ...
    imageElement.src = "../myWorld/assets/world240.png";
    imageElement.classList.remove("hidden");
    videoElement.classList.add("hidden");
    pageTitleElement.classList.add("hidden");
    mediaContainer.classList.remove("hidden");
    ...
    imageElement.src = "../myWorld/assets/world360.jpg";
    imageElement.classList.remove("hidden");
    videoElement.classList.add("hidden");
    pageTitleElement.classList.add("hidden");
    mediaContainer.classList.remove("hidden");
    ...
    imageElement.src = "../myWorld/assets/world480.png";
    imageElement.classList.remove("hidden");
    videoElement.classList.add("hidden");
    pageTitleElement.classList.add("hidden");
    mediaContainer.classList.remove("hidden");
    ...
    imageElement.src = "../myWorld/assets/world720.jpg";
    imageElement.classList.remove("hidden");
    videoElement.classList.add("hidden");
    pageTitleElement.classList.add("hidden");
    mediaContainer.classList.remove("hidden");
    ...
    videoElement.src = "../myWorld/assets/world1080.mp4";
